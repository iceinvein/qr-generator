	...
	return (
		<DefaultLayout>
			...
			<SEO
				...
				keywords="qr code generator, qr code maker, custom qr code, qr code with logo, wifi qr code, vcard qr code, free qr code, qr code creator, online qr generator"
			/>
			...
			<a
				href="#qr-preview"
				className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-32 focus:z-50 focus:px-4 focus:py-2 focus:bg-primary focus:text-white focus:rounded-md"
			>
				Skip to preview
			</a>
